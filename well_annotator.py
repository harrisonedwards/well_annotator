...
img_loc = 'well_image___20_09_2018___12.18.52.033870.tif'
output_loc = 'out.p'
...
class WellAnnotator():
    ...
    def write_to_file(self):
        pickle.dump((self.x_train,self.y_train),open(output_loc,'wb'))
    ...
    def annotate(self, event, x, y, flags, param):
        ...
        if event == 1 and flags == 1:
            ...
            self.annotated_img[self.annotation_position_y, self.annotation_position_x] = fill_val
            lineThickness = 2
            cv2.line(self.annotated_img, (self.last_x, self.last_y), (self.annotation_position_x, self.annotation_position_y), fill_val, lineThickness)
    ...
    def add_to_x_train(self):
        ...
        if self.x_train is None:
            ...
            self.x_train = np.concatenate((self.y_train, img), axis=-1)
